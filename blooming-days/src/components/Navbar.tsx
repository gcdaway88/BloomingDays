...
export default function Navbar() {
  return (
    <header className="sticky top-0 z-50 glass-nav border-b border-outline-variant/15 px-6 py-4 md:px-20 lg:px-40 flex items-center justify-between whitespace-nowrap">
      ...
      <div className="flex flex-1 justify-end gap-10 items-center">
        ...
        <Link
          href="/contact"
          className="flex min-w-[120px] cursor-pointer items-center justify-center rounded-xl h-10 px-5 primary-gradient text-on-primary text-sm font-bold tracking-wide editorial-shadow"
        >
          Order Now
        </Link>
      </div>
